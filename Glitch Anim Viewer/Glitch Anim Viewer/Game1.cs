...
namespace Glitch_Anim_Viewer
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        GlitchCharacter Character; // Character we wish to display
        ...
        protected override void LoadContent()
        {
            ...
            Character = new GlitchCharacter("PHV2HON5BG82O1J", GraphicsDevice); // I use my TSID here. Change this to Yours
